...
#define PIN_NUM_MISO RC522_SPI_BUS_GPIO_MISO
#define PIN_NUM_MOSI RC522_SPI_BUS_GPIO_MOSI
#define PIN_NUM_CLK  RC522_SPI_BUS_GPIO_SCLK
#define PIN_NUM_CS   RC522_SPI_SCANNER_GPIO_SDA

#define PIN_NUM_RST  RC522_SCANNER_GPIO_RST
